...
class Laporanpdf extends CI_Controller {
    ...
    function cetak(){
        ...
        $logo = media_url().'/images/download.jpg';
        $pdf->Image($logo,10,10,20,25);  

        $pdf->Cell(25);
        $pdf->SetFont('Times','B','12');
        $pdf->Cell(0,5,'YAYASAN TARBIYYATUL ISLAMIYYAH',0,1,'C');
        $pdf->Cell(25);
        $pdf->Cell(0,5,'DINAS PENDIDIKAN',0,1,'C');
        $pdf->Cell(25);
        $pdf->SetFont('Times','B','15');
        $pdf->Cell(0,5,'AL-KIROM-LAMPUNG SELATAN',0,1,'C');
        $pdf->Cell(25);
        $pdf->SetFont('Times','I','8');
        $pdf->Cell(0,5,'JL. Hj.Hasanuddin RT.08, Dusun 2 Kebon Bibit Jaya',0,1,'C');
        $pdf->Cell(25);
        $pdf->Cell(0,2,'Desa Hajimena Natar-Lampung Selatan Telp. (0852) 1705 6255',0,1,'C');
